...
% \color{% DarkGrey}
% \large{
% The ARDC is the RAiD Registration Agency for Australia and New Zealand. Researchers acquire RAiDs % through their organisations. 
% 
% The first step to using RAiD is for your organisation to establish a relationship with the ARDC. Email % \href{mailto:contact@raid.org}{contact@raid.org} to get started.
...
%----------------------------------------------------------------------------------------
% 'Getting started with RAiD in Europe' figure
%----------------------------------------------------------------------------------------
\begin{Figure}
 \centering
 \includegraphics[width=0.9\linewidth]{figures/raid-workflow-anz.png}
 \captionof{figure}{Getting started with RAiD in Europe.}
 \label{raid-workflow}
\end{Figure}
